...
*Légende   SEQ Légende\_ \\* ARABIC 1 Entité de la BO : Plat, avec propriétés et constructeurs ainsi que deux méthodes*
...
*Légende   SEQ Légende\_ \\* ARABIC 2 Entité de la BO : Utilisateur, avec propriétés et constructeurs ainsi que deux méthodes*
...
*Légende   SEQ Légende\_ \\* ARABIC 3 DTO : PlatPopularite pour la popularité d'un plat*
...
*Légende   SEQ Légende\_ \\* ARABIC 4 DTO : **PageRequest** avec **Page** et **PageSize** permettant une **pagination** quand il est en **requête***
...
*Légende   SEQ Légende\_ \\* ARABIC 5 GitHub Projects - Desktop Client FoodBook*

![](Aspose.Words.246ebee4-890a-4d49-bd04-d9d2ec216fce.009.png)

*Légende   SEQ Légende\_ \\* ARABIC 6 GitHub - Voir les modifications d'un commit*
##### GitLab
...
*Légende   SEQ Légende\_ \\* ARABIC 7 GitLab - Commit de mise en place d'un nouvel environment.dev.ts sur Angular sur le projet Expadon2 de Capgemini Bordeaux*
##### Jira
...
*Légende   SEQ Légende\_ \\* ARABIC 8 Jira - Capgemini Bordeaux*
#### *Solution choisie*
